...
Results_xlsx_path = "../Pre-Provided-Results/compare_for_pre_provided_A100_results.xlsx"
    ...
    for style_label in style_list:
        ...
        with plt.rc_context({"figure.max_open_warning": len(style_list)}):
            with plt.style.context(style_label):
                ...
                plt.savefig('figs/'+'fig_11_for_pre_provided_A100_results.pdf', format='pdf', bbox_inches='tight')
